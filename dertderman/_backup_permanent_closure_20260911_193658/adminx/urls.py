...
urlpatterns = [
    ...
    path(
        "kullanicilar/<int:pk>/askiya-al/",
        content_views.user_suspend,
        name="user_suspend",
    ),
    path(
        "kullanicilar/<int:pk>/askiyi-kaldir/",
        content_views.user_unsuspend,
        name="user_unsuspend",
    ),
    ...
    path(
        "sirket-raporlari/",
        views.company_report_list,
        name="company_report_list",
    ),
    path(
        "sirket-raporlari/<int:pk>/",
        views.company_report_detail,
        name="company_report_detail",
    ),
    path(
        "sirket-raporlari/<int:pk>/durum/",
        views.company_report_status,
        name="company_report_status",
    ),

    path(
        "kullanici-raporlari/",
        views.user_report_list,
        name="user_report_list",
    ),
    path(
        "kullanici-raporlari/<int:pk>/",
        views.user_report_detail,
        name="user_report_detail",
    ),
    path(
        "kullanici-raporlari/<int:pk>/durum/",
        views.user_report_status,
