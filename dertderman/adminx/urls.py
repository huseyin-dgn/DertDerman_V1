...
urlpatterns = [
    ...
    path("sirketler/<int:pk>/arsivle/", content_views.company_archive, name="company_archive"),
    path("sirket-basvurulari/", content_views.company_application_list, name="company_application_list"),
    path("sirket-basvurulari/<int:pk>/", content_views.company_application_detail, name="company_application_detail"),
    path("kullanicilar/", content_views.user_list, name="user_list"),
    path("kullanicilar/<int:pk>/", content_views.user_detail, name="user_detail"),
    path("bildirimler/", views.notifications, name="notifications"),
    path("bildirimler/<int:pk>/", views.notification_open, name="notification_open"),
    ...
    path("blog/<int:pk>/sil/", blog_views.post_delete, name="blog_delete"),
